...
import android.project.soundfile.SoundFile;
...
//                onAbout(this);
    ...
    private void loadGui() {
        ...
        setContentView(R.layout.ring_editor);
                ...
                try {
                    ...
                    if (mSoundFile == null) {
                        ...
                        if (components.length < 2) {
                            err = "不能剪辑不是.mp3和.wav格式的音乐";
                        } else {
                            err = "不能剪辑"+
                                    components[components.length - 1]+"格式的音乐";
                        }
    ...
    private void enableDisableButtons() {
        if (mIsPlaying) {
            mPlayButton.setBackground(getResources().getDrawable(R.mipmap.pause));
        } else {
            mPlayButton.setBackground(getResources().getDrawable(R.mipmap.play));
        }
    }
